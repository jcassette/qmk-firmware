...
#define SNLED27351_WRITE (0b0 << 7)
#define SNLED27351_READ (0b1 << 7)
#define SNLED27351_PATTERN (0b010 << 4)

#define SNLED27351_PAGE_LED_CONTROL 0x00
#define SNLED27351_PAGE_PWM 0x01
#define SNLED27351_PAGE_FUNCTION 0x03
#define SNLED27351_PAGE_CURRENT_TUNE 0x04

#define SNLED27351_FUNCTION_REG_SOFTWARE_SHUTDOWN ((SNLED27351_PAGE_FUNCTION << 8) | 0x00)
#define SNLED27351_SOFTWARE_SHUTDOWN_SSD_SHUTDOWN (0x0 << 0)
#define SNLED27351_SOFTWARE_SHUTDOWN_SSD_NORMAL (0x1 << 0)

#define SNLED27351_FUNCTION_REG_ID ((SNLED27351_PAGE_FUNCTION << 8) | 0x11)
#define SNLED27351_DRIVER_ID 0x8A

#define SNLED27351_FUNCTION_REG_PULLDOWNUP ((SNLED27351_PAGE_FUNCTION << 8) | 0x13)
#define SNLED27351_PULLDOWNUP_ALL_ENABLED 0xAA

#define SNLED27351_FUNCTION_REG_SCAN_PHASE ((SNLED27351_PAGE_FUNCTION << 8) | 0x14)
...
#define SNLED27351_FUNCTION_REG_SLEW_RATE_CONTROL_MODE_1 ((SNLED27351_PAGE_FUNCTION << 8) | 0x15)
#define SNLED27351_SLEW_RATE_CONTROL_MODE_1_PDP_ENABLE (0b1 << 2)

#define SNLED27351_FUNCTION_REG_SLEW_RATE_CONTROL_MODE_2 ((SNLED27351_PAGE_FUNCTION << 8) | 0x16)
#define SNLED27351_SLEW_RATE_CONTROL_MODE_2_SSL_ENABLE (0b1 << 6)
#define SNLED27351_SLEW_RATE_CONTROL_MODE_2_DSL_ENABLE (0b1 << 7)

#define SNLED27351_FUNCTION_REG_OPEN_SHORT_ENABLE ((SNLED27351_PAGE_FUNCTION << 8) | 0x17)
#define SNLED27351_OPEN_SHORT_ENABLE_SDS_ENABLE (0b1 << 6)
#define SNLED27351_OPEN_SHORT_ENABLE_ODS_ENABLE (0b1 << 7)

#define SNLED27351_FUNCTION_REG_OPEN_SHORT_DUTY ((SNLED27351_PAGE_FUNCTION << 8) | 0x18)

#define SNLED27351_FUNCTION_REG_OPEN_SHORT_FLAG ((SNLED27351_PAGE_FUNCTION << 8) | 0x19)
#define SNLED27351_OPEN_SHORT_FLAG_OSINT_ENABLE (0b1 << 6)
#define SNLED27351_OPEN_SHORT_FLAG_ODINT_ENABLE (0b1 << 7)

#define SNLED27351_FUNCTION_REG_SOFTWARE_SLEEP ((SNLED27351_PAGE_FUNCTION << 8) | 0x1A)
#define SNLED27351_SOFTWARE_SLEEP_ENABLE (0b1 << 1)

// LED Control Registers
#define SNLED27351_LED_CONTROL_ON_OFF_FIRST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x00)
#define SNLED27351_LED_CONTROL_ON_OFF_LAST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x17)
#define SNLED27351_LED_CONTROL_ON_OFF_LENGTH 0x18

#define SNLED27351_LED_CONTROL_OPEN_FIRST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x18)
#define SNLED27351_LED_CONTROL_OPEN_LAST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x2F)
#define SNLED27351_LED_CONTROL_OPEN_LENGTH 0x18

#define SNLED27351_LED_CONTROL_SHORT_FIRST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x30)
#define SNLED27351_LED_CONTROL_SHORT_LAST_ADDR ((SNLED27351_PAGE_LED_CONTROL << 8) | 0x47)
#define SNLED27351_LED_CONTROL_SHORT_LENGTH 0x18

// PWM Registers
#define SNLED27351_PWM_DUTY_FIRST_ADDR ((SNLED27351_PAGE_PWM << 8) | 0x00)
#define SNLED27351_PWM_DUTY_LAST_ADDR ((SNLED27351_PAGE_PWM << 8) | 0xBF)
#define SNLED27351_PWM_DUTY_LENGTH 0xC0

// Current Tune Registers
#define SNLED27351_CURRENT_TUNE_CCS_FIRST_ADDR ((SNLED27351_PAGE_CURRENT_TUNE << 8) | 0x00)
#define SNLED27351_CURRENT_TUNE_CCS_LAST_ADDR ((SNLED27351_PAGE_CURRENT_TUNE << 8) | 0x0B)
#define SNLED27351_CURRENT_TUNE_CCS_LENGTH 0x0C
